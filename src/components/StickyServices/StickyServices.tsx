...
const infrastructureCards: InfrastructureCard[] = [
  {
    ...
    desc: 'Heavy-duty internal road network with underground drainage, LED street cabling, and wide avenue access across the masterplan.',
    imgSrc: '/images/Blacktop Roads.png',
    alt: 'Wide Blacktop Internal Boulevard Roads',
    variantClass: '',
  },
  {
    number: '02',
    ...
    imgSrc: '/images/Gated Security.png',
    alt: 'Grand Gated Entrance Archway',
  ...
  },
  {
    ...
    imgSrc: '/images/Green Parks.png',
    alt: 'Landscaped Avenue Parks and Lawns',
  ...
  },
  {
    ...
    imgSrc: '/images/Utilities Grid.png',
    alt: 'Underground Utilities Grid',
